...
test("connector runtime code never calls the PMFreak governance/scenario/Control-Plane/Narrative-Export layers", () => {
...
test("connector runtime code implements no writeback/mutation behavior", () => {
  ...
  // words — AOC_PMFREAK_FORBIDDEN_CONNECTOR_OPERATIONS legitimately
  ...
  // "does not mutate" / "does not write back".
