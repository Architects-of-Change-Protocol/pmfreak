...
Solid arrows: mandatory relationships in the target model. Dashed arrows: ratified **optional shortcuts** — Workspace→Project, PMO→Project, PMO→Program, Portfolio→Project — that exist specifically so progressive disclosure and fast Project creation (D-06, D-12) are never blocked by the fuller hierarchy. This diagram represents ratified domain **capability**. It does not represent:
