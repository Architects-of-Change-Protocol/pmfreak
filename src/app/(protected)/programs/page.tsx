      ...
      <div className="relative space-y-8">
        <header className="relative overflow-hidden rounded-3xl border border-slate-200 bg-slate-50 p-6 md:p-8">
          ...
          <div className="relative max-w-3xl">
            <p className="text-xs uppercase tracking-[0.24em] text-indigo-800">Program Builder</p>
            <h1 className="mt-3 text-3xl font-semibold tracking-tight text-slate-900 md:text-4xl">Executable Programs</h1>
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <h2 className="mt-1 text-xl font-semibold text-slate-900">Your Programs</h2>
          </div>
          <Link
            href="/programs/new"
