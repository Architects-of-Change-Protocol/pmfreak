  ...
  return (
    <section className="relative overflow-hidden rounded-3xl border border-slate-200 bg-[#050507] p-6 shadow-[0_40px_120px_rgba(0,0,0,0.55)] md:p-10">
      ...
      <div className="relative mx-auto max-w-xl space-y-6">
        <div>
          <Link href="/programs" className="text-[10px] uppercase tracking-[0.2em] text-zinc-500 hover:text-zinc-700 transition">
            ← Programs
          </Link>
          <h1 className="mt-3 text-2xl font-semibold tracking-tight text-slate-900 md:text-3xl">New Program</h1>
