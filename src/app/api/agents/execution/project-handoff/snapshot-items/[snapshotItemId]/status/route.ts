...
export async function POST(request: Request, { params }: { params: { snapshotItemId: string } }) {
  try {
    ...
    const record = await updateAgentPmoProjectHandoffSnapshotItemStatus(params.snapshotItemId, body.itemStatus);
