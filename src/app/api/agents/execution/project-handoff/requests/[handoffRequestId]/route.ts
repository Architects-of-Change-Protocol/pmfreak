...
export async function GET(request: Request, { params }: { params: { handoffRequestId: string } }) {
  try {
    ...
    const record = await getAgentPmoProjectHandoffRequestById(params.handoffRequestId);
