...
export async function POST(request: Request, { params }: { params: { handoffPackId: string } }) {
  try {
    ...
    const record = await updateAgentPmoProjectHandoffPackStatus(params.handoffPackId, body.packStatus);
