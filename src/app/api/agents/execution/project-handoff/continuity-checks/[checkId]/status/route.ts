...
export async function POST(request: Request, { params }: { params: { checkId: string } }) {
  try {
    ...
    const record = await updateHandoffContinuityCheck(body.workspaceId, params.checkId, body.checkStatus, body.rationale);
