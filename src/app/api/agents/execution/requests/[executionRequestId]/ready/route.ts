...
import { markAgentExecutionReady } from "@/lib/agents";

const ROUTE = "/api/agents/execution/requests/[executionRequestId]/ready";
...
export async function POST(
  ...
  try {
    ...
    const executionRequest = await markAgentExecutionReady({
      workspaceId,
      executionRequestId,
