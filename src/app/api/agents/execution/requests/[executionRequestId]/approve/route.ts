...
import { approveAgentExecutionRequest } from "@/lib/agents";

const ROUTE = "/api/agents/execution/requests/[executionRequestId]/approve";
...
export async function POST(
  ...
  try {
    ...
    const executionRequest = await approveAgentExecutionRequest({
      workspaceId,
      executionRequestId,
