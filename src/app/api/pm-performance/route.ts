...
import { listLatestPMPerformanceSnapshots } from "@/lib/pm-performance";

const ROUTE = "/api/pm-performance";
...
export async function GET() {
  try {
    ...
    const result = await listLatestPMPerformanceSnapshots({ workspaceId });
    if (!result.ok) {
